...
namespace WindowsFormsApplication1
{
    public partial class UC_MQC_PieChart : UserControl
    {
        ...
        private void UC_MQC_PieChart_Load(object sender, EventArgs e)
        {
            ...
            SaveData.DateMQC = dtpChart.Value.ToString("yyyy-MM-dd");
            renderPiechart();
            //
        ...
        public void renderPiechart()
        {
            ...
            else
            {
                ...
                lbOP1.Text = "OK: " + dataL01[0].ToString() + "%";
                lbRW1.Text = "REWORK: " + dataL01[1].ToString() + "%";
                lbNG1.Text = "NG: " + dataL01[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP2.Text = "OK: " + dataL02[0].ToString() + "%";
                lbRW2.Text = "REWORK: " + dataL02[1].ToString() + "%";
                lbNG2.Text = "NG: " + dataL02[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP3.Text = "OK: " + dataL03[0].ToString() + "%";
                lbRW3.Text = "REWORK: " + dataL03[1].ToString() + "%";
                lbNG3.Text = "NG: " + dataL03[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP4.Text = "OK: " + dataL04[0].ToString() + "%";
                lbRW4.Text = "REWORK: " + dataL04[1].ToString() + "%";
                lbNG4.Text = "NG: " + dataL04[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP5.Text = "OK: " + dataL05[0].ToString() + "%";
                lbRW5.Text = "REWORK: " + dataL05[1].ToString() + "%";
                lbNG5.Text = "NG: " + dataL05[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP6.Text = "OK: " + dataL06[0].ToString() + "%";
                lbRW6.Text = "REWORK: " + dataL06[1].ToString() + "%";
                lbNG6.Text = "NG: " + dataL06[2].ToString() + "%";
            ...
            else
            {
                ...
                lbOP7.Text = "OK: " + dataL07[0].ToString() + "%";
                lbRW7.Text = "REWORK: " + dataL07[1].ToString() + "%";
                lbNG7.Text = "NG: " + dataL07[2].ToString() + "%";
