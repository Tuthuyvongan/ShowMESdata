    ...
    public partial class UC_PQC_PieChart : UserControl
    {
        ...
        public void changePanel()
        {
            ...
            if (SaveData.dtTemp2.Rows.Count > 0)
            {
                ...
                DataRow[] results11 = SaveData.dtTemp2.Select("Line = 'L01' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results22 = SaveData.dtTemp2.Select("Line = 'L02' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results33 = SaveData.dtTemp2.Select("Line = 'L03' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results44 = SaveData.dtTemp2.Select("Line = 'L04' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results55 = SaveData.dtTemp2.Select("Line = 'L05' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results66 = SaveData.dtTemp2.Select("Line = 'L06' and NG_rate_realtime > NG_rate_allow");
                ...
                DataRow[] results77 = SaveData.dtTemp2.Select("Line = 'L07' and NG_rate_realtime > NG_rate_allow");
