...
namespace SMESData
{
    public partial class UC_PQC_PieChart : UserControl
    {
        ...
        public void changePanel()
        {
            ...
            {
                DataRow[] results1 = SaveData.dtTemp2.Select("Line = 'L01'");
                DataRow[] results2 = SaveData.dtTemp2.Select("Line = 'L02'");
                DataRow[] results3 = SaveData.dtTemp2.Select("Line = 'L03'");
                DataRow[] results4 = SaveData.dtTemp2.Select("Line = 'L04'");
                DataRow[] results5 = SaveData.dtTemp2.Select("Line = 'L05'");
                DataRow[] results6 = SaveData.dtTemp2.Select("Line = 'L06'");
                DataRow[] results7 = SaveData.dtTemp2.Select("Line = 'L07'");
                //pn1
