...
namespace SMESData
{
    public partial class UC_PQC_PieChart : UserControl
    {
        ...
        public void  changePanel()
        {
            ...
            {
                DataRow[] results1 = SaveData.dtTemp2.Select("Line = 'L01' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results2 = SaveData.dtTemp2.Select("Line = 'L02' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results3 = SaveData.dtTemp2.Select("Line = 'L03' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results4 = SaveData.dtTemp2.Select("Line = 'L04' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results5 = SaveData.dtTemp2.Select("Line = 'L05' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results6 = SaveData.dtTemp2.Select("Line = 'L06' and NG_rate_realtime > NG_rate_allow");
                DataRow[] results7 = SaveData.dtTemp2.Select("Line = 'L07' and NG_rate_realtime > NG_rate_allow");
                //pn1
